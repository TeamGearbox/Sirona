...
<html>
    ...
    <header class="w3-top">
      <div class="w3-bar w3-pale-green w3-top w3-left-align w3-large">
        <a href="#" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Welcome, &lt;patientUserName&gt;</a>
      </div>
    </header>
    ...
    <nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
      ...
      <a class="w3-bar-item w3-button w3-hover-pale-green" href="#">Home</a>
      <a class="w3-bar-item w3-button w3-hover-pale-green" href="#">Appointments</a>
      <a class="w3-bar-item w3-button w3-hover-pale-green" href="#">Messages</a>
      <a class="w3-bar-item w3-button w3-hover-pale-green" href="#">Billing</a>  
      <a class="w3-bar-item w3-button w3-hover-pale-green" href="#">Health</a>
      <a class="w3-bar-item w3-button w3-hover-pale-green" href="#">Profile</a>
    </nav>
