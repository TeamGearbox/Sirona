...
<html>
    ...
    <body>
        ...
        <!-- Header -->
        <header class="w3-top">
            <div class="w3-bar w3-pale-green w3-top w3-left-align w3-large">
        ...
        <nav class="w3-sidebar w3-bar-block w3-large" id="mySidebar">
            ...
            <button class="tablinks w3-bar-item w3-button w3-hover-pale-green" onclick="openTab(event, 'Home')" id="defaultOpen">Home</button>
            <button class="tablinks w3-bar-item w3-button w3-hover-pale-green" onclick="openTab(event, 'Appointments')">Appointments</button>
            
            <!-- Message accordion -->
            <button class="accordion w3-hover-pale-green">Messages</button>
            <div class="panel">
                <button class="tablinks w3-bar-item w3-button w3-hover-pale-green" onclick="openTab(event, 'Compose')">Compose</button>
                <button class="tablinks w3-bar-item w3-button w3-hover-pale-green" onclick="openTab(event, 'Inbox')">Inbox</button>
                <button class="tablinks w3-bar-item w3-button w3-hover-pale-green" onclick="openTab(event, 'Sent')">Sent</button>
            </div>
            
            <button class="tablinks w3-bar-item w3-button w3-hover-pale-green" onclick="openTab(event, 'Billing')">Billing</button>  
            <button class="tablinks w3-bar-item w3-button w3-hover-pale-green" onclick="openTab(event, 'Health')">Health</button>
            <button class="tablinks w3-bar-item w3-button w3-hover-pale-green" onclick="openTab(event, 'Profile')">Profile</button>
        </nav>
        ...
        <div class="w3-row w3-padding-64">
            ...
            <div class="w3-main" style="margin-left:250px" id="Appointments">
                <div class="w3-twothird w3-container">
                    ...
                    <p>Appointments form goes here</p>
                </div>
            </div>
            ...
            <div class="w3-main" style="margin-left:250px" id="Billing">
                <div class="w3-twothird w3-container">
                    <h1 class="w3-text-teal">Billing</h1>
                    <p>Billing content goes here</p>
                </div>
            </div>
            <!-- end of billing content -->
            
            <!-- patient health content -->
            <div class="w3-main" style="margin-left:250px" id="Health">
                <div class="w3-twothird w3-container">
                    <h1 class="w3-text-teal">Health Form</h1>
                    <p>Health form goes here</p>
                </div>
            </div>
            <!-- end of health page content -->
