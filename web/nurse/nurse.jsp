...
<html>
    ...
    <nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
      ...
      <a class="w3-bar-item w3-button w3-hover-indigo" href="#">Home</a>
      <a class="w3-bar-item w3-button w3-hover-indigo" href="#">Messages</a>
      <a class="w3-bar-item w3-button w3-hover-indigo" href="#">Chart</a>  
      <a class="w3-bar-item w3-button w3-hover-indigo" href="#">Profile</a>
    </nav>
